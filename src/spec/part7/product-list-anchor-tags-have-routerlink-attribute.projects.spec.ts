...
describe('ProductListComponent', () => {
  ...
  it(`should have anchor elements that have a routerLink attribute with the correct values @product-list-anchor-tags-have-routerlink-attribute`, waitForAsync(() => {
