...
describe('ProductDescription', () => {
  ...
  it(`should use release date data from the albumInfo property in the HTML template @product-description-html-uses-dynamic-albuminfo-releasedate`, waitForAsync(() => {
